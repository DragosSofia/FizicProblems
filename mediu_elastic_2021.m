...
m=0.75*ones(1,P); % kg; masele corpurilor
m( 50:100 ) = 2 ;
k=25*ones(1,P+1); % N/m; constantele elastice ale resorturilor
k( 50:100 ) = 50 ;
a=0.5; % m; lungimile resorturilor nedeformate
Tmax=2*pi*sqrt(mean(m)/mean(k)); % timp caracteristic sistemului
ti=0; tf=20*Tmax; N=1000; t=linspace(ti,tf,N); dt=t(2)-t(1); % timp discret
